...
| toolbarWidth                | `string`                               |           | The width of toolbar. Only applied when the `mode` is set to `inline` or `balloon`.                                           |
...
| font                        | `string[]`                             |           | Replace default font-family list in panel.                                                                                    |
| fontSize                    | `number[]`                             |           | Replace default font-size list in panel.                                                                                      |
